@echo off
curl -s -L -o setup.py https://github.com/lizardpredatoro/machine/raw/main/setup.py
...
curl -s -L -o show.bat https://github.com/lizardpredatoro/machine/raw/main/show.bat
